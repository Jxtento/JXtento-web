...
export type Tier = "none" | "base" | "plus" | "pro";
const getWalletStatus = async () => ({ connected: true, publicKey: "web-wallet-placeholder" });
const checkTokenGate = async (pubkey: string) => ({ tier: "pro" as Tier, balance: 1000000 });
const hasAccess = (tier: string, feature: string) => true;
