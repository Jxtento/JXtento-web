  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <header className="relative z-10 w-full max-w-[1200px] mx-auto px-4 md:px-[32px] pt-[80px] pb-[60px] md:pt-[120px] md:pb-[100px] grid grid-cols-1 md:grid-cols-[1fr_minmax(340px,460px)] gap-12 md:gap-[80px] items-center">
        ...
        {process.env.NEXT_PUBLIC_JXTENTO_CA && (
          <div className="mb-[24px] relative z-10">
            <p className="text-[11px] text-[var(--muted)] mb-2 font-mono uppercase tracking-[.14em]">Official Contract Address:</p>
            <a 
              href={`https://pump.fun/${process.env.NEXT_PUBLIC_JXTENTO_CA}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[rgba(251,250,247,0.95)] backdrop-blur-sm border border-[var(--line)] px-4 py-3 hover:bg-[rgba(240,240,240,0.95)] transition-colors shadow-sm"
            >
              <span className="font-mono text-[14px] font-medium text-[#39352F]">{process.env.NEXT_PUBLIC_JXTENTO_CA}</span>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--muted)]"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
            </a>
          </div>
        )}
